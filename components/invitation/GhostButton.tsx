...
const eventShellStyles =
  "inline-flex w-[16.5rem] rounded-full bg-[linear-gradient(90deg,#666666_0%,#FFFFFF_57.21%,#616161_97.6%,#646464_99.99%)] p-px shadow-[0_4px_16px_rgba(0,0,0,0.35)]";

const eventInnerStyles =
  "inline-flex w-full items-center justify-center whitespace-nowrap rounded-full bg-[#002859] px-8 py-2.5 font-serif text-base font-normal normal-case tracking-normal text-white transition hover:brightness-110";
